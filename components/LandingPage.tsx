    ...
    return (
        <div className="flex flex-col items-center justify-start w-full h-full py-10">
            <HeroHighlight>
                ...
                >
                    With plot twist <br /> <span className="italic font-thin"> Nothing&apos;s real.</span><br /> <span className="font-mono font-medium ">Everything is far away.</span> <br />
                    <span className="italic font-light ">Everything is an</span>
                    <br />
            ...
            <div className="max-w-5xl px-8 mx-auto">
                <h2 className="pb-6 text-5xl font-bold text-center">Popular Topics</h2>
